...
import { f as useNuxtApp, c as createError, e as useRuntimeConfig } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { hash } from 'ohash';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-e2429121.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-b338a84e.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-d736c54c.mjs.map
